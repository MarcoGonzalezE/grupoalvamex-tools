...
var TimeCounter = common.AbstractField.extend(common.ReinitializeFieldMixin, {
    ...
    render_value: function() {
        ...
        var self = this;
        this.duration;
        var productivity_domain = [['sale_order_id', '=', this.field_manager.datarecord.id], ['user_id', '=', self.session.uid]];
        new Model('sale.order.times').call('search_read', [productivity_domain, []]).then(function(result) {
